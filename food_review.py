...
# list = {1: 'menu', 2: 'show reviews please'}
# answer = input('what would you like to see? 1. menu or 2. reviews?: ')
# answer = int(answer)
# if answer == 1:
#     answer_1 = input('would you like to search?: ').lower()
#     if 'y' in answer_1:
...
#         if answer_2 == 1:
#             while True:
#                 answer = input('any specific?(yes or no): ').lower()
#                 if 'y' in answer:
...
#                 if 'y' in answer:
#                     list = {1: 'create', 2: 'delete', 3: 'update'}
#                     answer = int(input('what would you like to do? 1: create a review, 2: delete a review, 3: update a review?: '))
#                     if answer == 1:
